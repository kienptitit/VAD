...
class Aggregate(nn.Module):
    def __init__(self, len_feature):
        ...
        self.conv_1 = nn.Sequential(
            nn.Conv1d(in_channels=len_feature, out_channels=256, kernel_size=3,
        ...
        self.conv_4 = nn.Sequential(
            nn.Conv1d(in_channels=len_feature, out_channels=256, kernel_size=1,
        ...
        self.non_local = NONLocalBlock1D(256, sub_sample=False, bn_layer=True)
...
class rtfm(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return out.reshape(bs, ncrops, t, f)


if __name__ == '__main__':
    inp = torch.randn(16, 1, 32, 1024)
    model = rtfm(1024)
